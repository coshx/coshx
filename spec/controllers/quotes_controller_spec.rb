...
describe QuotesController do
  ...
  describe "GET edit" do
    it "not admin can't edit" do
      quote = Quote.create! valid_attributes
      get :edit, {:id => quote.to_param}
      assigns(:quote).should_not eq(quote)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quote" do
        ...
        put :update, {:id => quote.to_param, :quote => {'these' => 'params'}}
      end

      it "assigns the requested quote as @quote" do
        sign_in admin
        quote = Quote.create! valid_attributes
        put :update, {:id => quote.to_param, :quote => valid_attributes}
        assigns(:quote).should eq(quote)
      end
    ...
    describe "with invalid params" do
      it "assigns the quote as @quote" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quote.any_instance.stub(:save).and_return(false)
        put :update, {:id => quote.to_param, :quote => {}}
        assigns(:quote).should eq(quote)
      end
